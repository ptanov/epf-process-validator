...
public class ProjectIterationDescriptionPage extends CustomCategoryDescriptionPage {
	...
	public ProjectIterationDescriptionPage(FormEditor editor) {
		super(editor);
	...
	public void init(IEditorSite site, IEditorInput input) {
		...
		// without variability - if on - it searches in custom categories, not in ProjectIterations
	...
	public void loadSectionDescription() {
		this.generalSectionDescription = ProjectIterationUIResources.projectIteration_generalInfoSection_desc;
		this.detailSectionDescription = ProjectIterationUIResources.projectIteration_detailSection_desc;
		this.variabilitySectionDescription = ProjectIterationUIResources.projectIteration_variabilitySection_desc;
		this.versionSectionDescription = ProjectIterationUIResources.projectIteration_versionInfoSection_desc;
		this.iconSectionDescription = ProjectIterationUIResources.projectIteration_IconSection_desc;
	}
