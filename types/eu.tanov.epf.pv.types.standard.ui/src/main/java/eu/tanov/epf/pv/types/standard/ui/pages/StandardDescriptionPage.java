...
public class StandardDescriptionPage extends CustomCategoryDescriptionPage {
	...
	public StandardDescriptionPage(FormEditor editor) {
		super(editor);
	...
	public void init(IEditorSite site, IEditorInput input) {
		...
		// without variability - if on - it searches in custom categories, not in Standards
	...
	public void loadSectionDescription() {
		this.generalSectionDescription = StandardUIResources.standard_generalInfoSection_desc;
		this.detailSectionDescription = StandardUIResources.standard_detailSection_desc;
		this.variabilitySectionDescription = StandardUIResources.standard_variabilitySection_desc;
		this.versionSectionDescription = StandardUIResources.standard_versionInfoSection_desc;
		this.iconSectionDescription = StandardUIResources.standard_IconSection_desc;
	}
