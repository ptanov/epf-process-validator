...
import eu.tanov.epf.pv.types.project.ui.pages.ProjectTasksPage;
import eu.tanov.epf.pv.types.project.ui.pages.ProjectWorkProductsPage;
...
public class ProjectPageProviderExtension implements IMethodElementEditorPageProviderExtension {
	...
	public Map<Object, String> getPages(Map<Object, String> pageMap, FormEditor editor, Object input) {
		if (ProjectHelper.isProject(input)) {
			...
			pageMap.put(new ProjectTasksPage(editor), null);
			pageMap.put(new ProjectWorkProductsPage(editor), null);
