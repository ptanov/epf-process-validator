package eu.tanov.epf.pv.types.projectpractice.ui;
 ...
 */
public class ProjectPracticeActivator extends AbstractUIPlugin {
	...
	// The plug-in ID
	public static final String PLUGIN_ID = "eu.tanov.epf.pv.types.projectpractice.ui"; //$NON-NLS-1$

	// The shared instance
	private static ProjectPracticeActivator plugin;

	/**
	 * The constructor
	 */
	public ProjectPracticeActivator() {
	}
	 ...
	 */
	public static ProjectPracticeActivator getDefault() {
		return plugin;
	}
