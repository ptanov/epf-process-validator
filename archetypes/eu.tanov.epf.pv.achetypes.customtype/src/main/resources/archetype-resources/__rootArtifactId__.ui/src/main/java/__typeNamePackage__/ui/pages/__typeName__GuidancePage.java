...
public class ${typeName}GuidancePage extends ContentElementGuidancePage {
	private static final String classNameForFormTitle = ${typeName}UIResources.${typeNameVariable}_text;

	public ${typeName}GuidancePage(FormEditor editor) {
		super(editor);
	...
	protected String getSectionDescription() {
		return ${typeName}UIResources.${typeNameVariable}_guidancepage_sectiondescription;
	}
}
