...
public class ${typeName}DescriptionPage extends CustomCategoryDescriptionPage {
	private static final String classNameForFormTitle = ${typeName}UIResources.${typeNameVariable}_text;
	...
	public ${typeName}DescriptionPage(FormEditor editor) {
		super(editor);
	...
	public void loadSectionDescription() {
		this.generalSectionDescription = ${typeName}UIResources.${typeNameVariable}_generalInfoSection_desc;
		this.detailSectionDescription = ${typeName}UIResources.${typeNameVariable}_detailSection_desc;
		this.variabilitySectionDescription = ${typeName}UIResources.${typeNameVariable}_variabilitySection_desc;
		this.versionSectionDescription = ${typeName}UIResources.${typeNameVariable}_versionInfoSection_desc;
		this.iconSectionDescription = ${typeName}UIResources.${typeNameVariable}_IconSection_desc;
	}
