...
public class SelectParentFeaturePage extends WizardPage {

	public SelectParentFeaturePage() {
		// TODO i18n
		super("Select feature");
		setTitle("Feature in parent");
		setDescription("Select feature in parent");
	...
	public void createControl(Composite parent) {
		setTitle("Feature in parent " + ((ConsistencyWizard) getWizard()).getEclass().getName());
		setDescription("Select feature in parent " + ((ConsistencyWizard) getWizard()).getEclass().getName());
	...
	private void updateStatus(Object selected, ITreeSelection iTreeSelection) {
		((ConsistencyWizard) getWizard()).setSelectedParentPath(null);
		setPageComplete(false);
		if (selected instanceof EReference) {
			((ConsistencyWizard) getWizard()).setSelectedParentPath(iTreeSelection.getPathsFor(selected));
